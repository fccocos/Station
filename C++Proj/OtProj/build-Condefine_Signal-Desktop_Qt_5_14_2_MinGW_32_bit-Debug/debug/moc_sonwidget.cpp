...
#include <memory>
#include "../../Condefine_Signal/sonwidget.h"
...
QT_MOC_LITERAL(1, 10, 16), // "show_hide_signal"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 1), // "a"
QT_MOC_LITERAL(4, 30, 13) // "emit_mySignal"

    },
    "SonWidget\0show_hide_signal\0\0a\0"
    "emit_mySignal"
};
...
void SonWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->show_hide_signal((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SonWidget::show_hide_signal)) {
                *result = 0;
                return;
            }
        }
